/* ==========================================================================
   DNFL API Client Middleware (v3.01-TEST3)
...
(function (window, document) {
    ...
    // ----------------------------------------------------------------------
    // Cache Engine (RAM, LocalStorage, & Cross-Tab Broadcast Sync)
    // ----------------------------------------------------------------------
    ...
    DNFL.Cache = {
        ...
        set: function (key, value, ttlMs) {
            ...
            try {
                ...
                console.warn(`[DNFL.Cache] LocalStorage full for "${prefixedKey}". Evicting stale items...`);
                this.evictStale();
                try {
                    localStorage.setItem(prefixedKey, JSON.stringify(payload));
                } catch (retryErr) {
    ...
    // ----------------------------------------------------------------------
    // Client Configuration & Active Fetch Tracker
    // ----------------------------------------------------------------------
    const CONFIG = {
