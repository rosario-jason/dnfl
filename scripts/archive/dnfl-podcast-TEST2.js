/* ==========================================================================
   DNFL Podcast Module Engine (v3.00-TEST2)
   Duke Networking Fantasy League (DNFL)
   ==========================================================================
   Provides an audio player interface and automated transcript renderer for 
   The Devil's Advocate podcast. Features robust relative URL resolution,
   on-demand Marked.js hydration, dynamic episode switching, and collapsible
   transcript viewing.
   ========================================================================== */
...
(function (window, document) {
    ...
    async function init(yearOverride) {
        ...
        // Normalize episode audio/transcript URLs against dnfl.live domain
        episodeList = episodeList.map(ep => ({
            ...ep,
            audio: resolveMediaUrl(ep.audio || `${ep.id}.m4a`, podcastMFLYear),
            transcript: resolveMediaUrl(ep.transcript || `${ep.id}.md`, podcastMFLYear)
        }));
