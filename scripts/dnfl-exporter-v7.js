// dnfl-exporter-v7.js v7.0
/* ==========================================================================
   DNFL Commissioner Data Exporter Engine v7.0
   Repository: rosario-jason/dnfl
   File: scripts/dnfl-exporter-v7.js
...
(function() {
    ...
    async function generateStandingsReport() {
        ...
        return {
            ...
            columns: ["Rank", "Franchise ID", "Team Name", "Owner", "Conference", "Division", "Wins", "Losses", "Ties", "Win Pct", "Points For (PF)", "Points Against (PA)", "Streak"],
            rows: rows
        };
    }
