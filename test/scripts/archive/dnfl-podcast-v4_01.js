/* ==========================================================================
   DNFL Podcast Module Engine v4.01
   Duke Networking Fantasy League (DNFL)
   ==========================================================================
   Streamlined, modern podcast player module. Strictly targets the HPM spec 
   with class-based visibility toggling, safe API middleware resolution, 
   and clean, decoupled SCSS styling.
   ========================================================================== */
    ...
    function toggleTranscript() {
        ...
        if (btn) {
            btn.innerHTML = isHidden 
                ? `<i class="fa-solid fa-scroll"></i> <span class="btn-text-full">Show Transcript</span><span class="btn-text-short">Transcript</span>`
                : `<i class="fa-solid fa-scroll"></i> <span class="btn-text-full">Hide Transcript</span><span class="btn-text-short">Transcript</span>`;
        }
    }
