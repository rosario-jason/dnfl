/* ==========================================================================
   DNFL Dynamic Standings & Seeding Engine v4.03 (Architecture Aligned)
   ...
   uniform square rank badges, green/red PF/PA badges, and repeating subheaders.
   ========================================================================== */
(function() {
    'use strict';
    ...
    function updateDnflStandingsView() {
        ...
        divisionsToRender.forEach(div => {
            ...
            if (hasRealDivision) {
                tableHtml += `
                    <tr class="dnfl-division-header dnfl-div-row-${div.id}">
