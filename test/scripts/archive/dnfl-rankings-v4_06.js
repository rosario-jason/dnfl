/* ==========================================================================
   DNFL Power Rankings Dashboard Engine v4.06 (Architecture Aligned)
...
(function() {
    ...
    function normId(id) {
        ...
        return urlParams.get('L') || urlParams.get('l') || window.league_id || window.mflLeagueId || '';
    }
    ...
    function renderChartAndTable(records, activeConfFilter = 'All') {
        ...
        sortedData.forEach((item, index) => {
            ...
            const activeHost = window.location.hostname || "www27.myfantasyleague.com";
            const activeLeagueId = getLeagueId();
            const targetHref = activeLeagueId 
                ? `https://${activeHost}/${rankingsMFLYear}/options?L=${activeLeagueId}&F=${item.franchiseId}&O=01`
                : `#`;
