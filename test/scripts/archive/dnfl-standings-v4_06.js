/* ==========================================================================
   DNFL Dynamic Standings & Seeding Engine v4.06 (Architecture Aligned)
   Duke Networking Fantasy League (DNFL)
   Fully aligned with dnfl-global-v3_36.css & _test_v4_38.scss design tokens.
   ...
   uniform square rank badges, green/red PF/PA badges, dynamic card title,
   and clean division collapsible toggling.
   ========================================================================== */
(function() {
    'use strict';
    ...
    function toggleDnflDivision(divId) {
        ...
        const currentlyHidden = firstRow.style.display === 'none';
