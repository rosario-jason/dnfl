/* ==========================================================================
   DNFL Dynamic Standings & Seeding Engine v4.01 (v4 Architecture Aligned)
   Duke Networking Fantasy League (DNFL)
   Fully aligned with dnfl-global-v3_36.css & _test_v4_35.scss design tokens.
   Supports dynamic API metadata fetch via DNFL.Client, standings_rules.json,
   auto logged-in owner highlight, resilient data-index zebra striping, and 
   uniform square rank badges.
   ========================================================================== */
(function() {
    'use strict';
    ...
    function buildTeamRowHtml(profile, divId, confRules, rowCounter) {
        ...
        return `
            <tr class="${rowClass}">
                ...
                <td class="dnfl-col-pf dnfl-hide-mobile dnfl-standings-pf">${pf}</td>
                <td class="dnfl-col-pa dnfl-hide-mobile dnfl-standings-pa">${pa}</td>
