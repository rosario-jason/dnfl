/* ==========================================================================
   DNFL Commissioner Data Exporter Engine v4.30 (Architecture Aligned)
...
(function() {
    ...
    async function generatePowerRankingsReport(targetWeek) {
        ...
        const currentWeekClamped = Math.max(1, Math.min(regWeeks, weekNum));
        const stepDenominator = Math.max(1, regWeeks - 1);
        const perfWeight = 0.20 + (0.65 * (currentWeekClamped - 1) / stepDenominator);
        const projWeight = 1.0 - perfWeight;
        ...
        statList.forEach((s, idx) => {
            ...
            s.calculatedIndex = parseFloat(finalPowerScoreRaw.toFixed(1));
        });
