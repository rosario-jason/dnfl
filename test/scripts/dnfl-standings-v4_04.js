/* ==========================================================================
   DNFL Dynamic Standings & Seeding Engine v4.04
   Duke Networking Fantasy League (DNFL)
   Fully aligned with dnfl-global-v3_36.css & _test_v4_37.scss design tokens.
   ...
   uniform square rank badges, green/red PF/PA badges, repeating subheaders,
   responsive legend layout, and non-collapsing division header bars.
   ========================================================================== */
(function() {
    'use strict';
