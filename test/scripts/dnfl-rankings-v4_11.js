/* ==========================================================================
   DNFL Power Rankings Dashboard Engine v4.11 (Architecture Aligned)
...
(function() {
    ...
    function renderChartAndTable(records, activeConfFilter = 'All') {
        ...
        sortedData.forEach((item, index) => {
            ...
            const rankBadgeHtml = `
                <span class="dnfl-rank-badge" style="background-color: ${palette.bg}; border: 1px solid ${palette.border}; color: #ffffff; padding: 4px 8px; border-radius: 6px; font-weight: 700; font-size: 0.85rem;">
                    ${displayRank}
                </span>
            `;
