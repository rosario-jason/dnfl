...
(function() {
    ...
    function updateIconState(iconEl, isExpanded) {
        ...
        if (iconEl.classList.contains('dnfl-rules-icon')) {
            iconEl.className = isExpanded ? 'fa-solid fa-chevron-down dnfl-rules-icon' : 'fa-solid fa-chevron-right dnfl-rules-icon';
        } else if (iconEl.classList.contains('dnfl-sub-icon')) {
            iconEl.className = isExpanded ? 'fa-solid fa-caret-down dnfl-sub-icon' : 'fa-solid fa-caret-right dnfl-sub-icon';
        } else if (iconEl.classList.contains('dnfl-topic-icon')) {
            iconEl.className = isExpanded ? 'fa-solid fa-angle-down dnfl-topic-icon' : 'fa-solid fa-angle-right dnfl-topic-icon';
        }
    }
