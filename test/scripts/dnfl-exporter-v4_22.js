/* ==========================================================================
   DNFL Commissioner Data Exporter Engine v4.22 (Architecture Aligned)
...
(function() {
    ...
    async function getLeagueInfo() {
        ...
        try {
            ...
            const curWk = cachedMflStatus?.currentWk 
                || cachedMflStatus?.current_week 
                || cachedMflStatus?.week
